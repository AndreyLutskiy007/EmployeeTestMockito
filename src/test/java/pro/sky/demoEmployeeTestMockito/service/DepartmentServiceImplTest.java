...
class DepartmentServiceImplTest {
    ...
    void getEmployeeWithMinSalary_success() {
        ...
        float maxSalary = 35;
        float minSalary = 15;
        Employee employeeWithMaxSalary = new Employee("Dmitriy", "Orlov", maxSalary, DEPARTMENT_BY_ID.get(departmentId));
        Employee employeeWithMinSalary = new Employee("Oksana", "Naumova", minSalary, DEPARTMENT_BY_ID.get(departmentId));
